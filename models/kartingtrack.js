...
//const opts = { toJSON: { virtuals: true } };    //By default, Mongoose does not include virtuals when you convert a document to JSON so we need to set this to true so that we can access the data returned by the virtual function in mapbox implementation of popup.
...
}); //opts should be passed here as a parameter
...
// });  But this virtual is not being used because it is breaking the JSON string
//Instead I am manually iterating trough each kartTrack in the clusterMap.js file and adding in the properties field
